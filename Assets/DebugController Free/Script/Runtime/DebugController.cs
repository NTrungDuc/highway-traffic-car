...
namespace HT.DEBUG
{
    ...
    public sealed class DebugController : MonoBehaviour
    {
        ...
        private void ExpansionDrawCallGUI()
        {
            ...
            GUILayout.Label(_localization.LanguageValue(38) + ": " + UnityEditor.UnityStats.triangles + " Triangles");
            GUILayout.Label(_localization.LanguageValue(39) + ": " + UnityEditor.UnityStats.vertices + " Vertices");
#else
