...
public class RCC_Editor : Editor {
    ...
    private void WheelSettingsTab() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("FrontLeftRimTransform"), new GUIContent("Front Left Rim Model", "Select front left rim of your vehicle."), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("FrontLeftTireTransform"), new GUIContent("Front Left Tire Model", "Select front left tire of your vehicle."), false);
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("FrontRightRimTransform"), new GUIContent("Front Right Rim Model", "Select front right rim of your vehicle."), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("FrontRightTireTransform"), new GUIContent("Front Right Tire Model", "Select front right tire of your vehicle."), false);
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("RearLeftRimTransform"), new GUIContent("Rear Left Rim Model", "Select rear left rim of your vehicle."), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("RearLeftTireTransform"), new GUIContent("Rear Left Tire Model", "Select rear left tire of your vehicle."), false);
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("RearRightRimTransform"), new GUIContent("Rear Right Rim Model", "Select rear right rim of your vehicle."), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("RearRightTireTransform"), new GUIContent("Rear Right Tire Model", "Select rear right tire of your vehicle."), false);
        EditorGUILayout.Space();
        ...
        if (!Application.isPlaying) {
            ...
            {
                carScript.FrontLeftWheelCollider.rimModel = carScript.FrontLeftRimTransform;
                carScript.FrontLeftWheelCollider.tireModel = carScript.FrontLeftTireTransform;
            ...
            {
                carScript.FrontRightWheelCollider.rimModel = carScript.FrontRightRimTransform;
                carScript.FrontRightWheelCollider.tireModel = carScript.FrontRightTireTransform;
            ...
            {
                carScript.RearLeftWheelCollider.rimModel = carScript.RearLeftRimTransform;
                carScript.RearLeftWheelCollider.tireModel = carScript.RearLeftTireTransform;
            ...
            {
                carScript.RearRightWheelCollider.rimModel = carScript.RearRightRimTransform;
                carScript.RearRightWheelCollider.tireModel = carScript.RearRightTireTransform;
    ...
    private void ConfigurationTab() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("NitroTime"), new GUIContent("Maximum Nitro Time"), false);
