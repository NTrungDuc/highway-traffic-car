...
public class RCC_InputManager : RCC_Singleton<RCC_InputManager> {
    ...
    public delegate void onNitro();
    public static event onNitro OnNitro;
    ...
    public void GetInputs() {
        ...
        if (inputActions == null) {
            ...
            inputActions.Vehicle.Nitro.performed += Nitro_performed;
    ...
    private static void Nitro_performed(InputAction.CallbackContext obj)
    {
        if (OnNitro != null)
            OnNitro();
    }
